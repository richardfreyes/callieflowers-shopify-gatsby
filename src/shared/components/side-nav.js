...
export default class SideNavigation extends React.Component {
  ...
  render() {
    return (
      <div>
        <div class={`fb-sidebar sidebar-clear ${this.state.sideNavState ? 'active' : null}`} id="sidebarClear"></div>
        <nav className={`fb-sidebar sidebar-fixed ${this.state.sideNavState ? 'active' : null}`} id="sidebar">
          ...
          <ul className="list-unstyled social">
            <li><Link to="/"><span className="social-icon ei-facebook"></span></Link></li>
            <li><Link to="/"><span className="social-icon ei-instagram"></span></Link></li>
          </ul>
