...
class HeroBanner extends React.Component {
  onScroll() {
    var winScroll = document.getElementById("scrollCategory").scrollLeft;
    var width = document.getElementById("scrollCategory").scrollWidth - document.getElementById("scrollCategory").clientWidth;
    var scrolled = (winScroll / width) * 52;
      ...
      <div className="section intro">
        <div className="container">
          <div className="row row-holder">
            <div className="col-holder col-xl-10 col-lg-9 col-md-12 col-12">
              ...
              <Slider className="featured-slider d-none d-md-block" {...bannerSlider}>
                <Link to='/collections/valentines'>
                  <StaticImage src="../../images/home/v2/vday-banner-desk.png" layout="fullWidth" alt="Valentines Flowers" />
                </Link>
              ...
              <Slider className="featured-slider d-xs-block d-md-none" {...bannerSlider}>
                <Link to='/collections/valentines'>
                  <StaticImage src="../../images/home/v2/vday-banner-mob.png" layout="fullWidth" alt="Valentines Flowers"/>
                </Link>
          ...
          <div className="categories">
            ...
            <ul className="scroll-category" id="scrollCategory" onScroll={this.onScroll}>
              <li>
